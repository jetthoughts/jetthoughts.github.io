...
The [outreach](/course/tech-for-non-technical-founders-2026/find-10-people-with-problem-outreach-2026/) went out five messages a day, each one naming the specific post: "You wrote that three centers never called you back - I'm researching exactly that failure and would trade 20 minutes for everything you learned." No pitch, no product link. Eight of the first twenty replied; by the end of the second week she had ten calls on the calendar, and a waitlist parent from her smoke-test page made eleven.
