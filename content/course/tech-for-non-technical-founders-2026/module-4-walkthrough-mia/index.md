...
The five questions took her twenty minutes. Q1, validation: ten interviews with eight strong signals, plus six founding members who had already paid $99 - yes, with receipts. Q2, backend weight: her v1 had no real-time anything, no background queues, no regulated data - a curated list, parent accounts, and one request button. Light. Q3 and Q4 settled it before she ever reached Q5: her budget was her own evenings, not a contractor retainer, and the worksheet routes an evenings-and-weekends budget straight to Path 2 - self-serve.
...
She read the five signals once, put a recurring monthly block on her calendar titled "ceiling check," and closed the tab. First run: scheduled for thirty days after launch. That is the whole lesson when your MVP is nine days old.
