...
📋 Template companion to [the Mom Test synthesis section](/blog/mom-test-ask-about-past-not-future/#synthesis-write-down-what-you-heard-decide-whats-next). Print after running 10 interviews. Fill in 30 minutes. Show to 2 advisors before building anything.
...
Use the markdown block below directly in Notion, or print the PDF version (the SVG version of the page is embedded in the [Mom Test synthesis section](/blog/mom-test-ask-about-past-not-future/#synthesis-write-down-what-you-heard-decide-whats-next)).
