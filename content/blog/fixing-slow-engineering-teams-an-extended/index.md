...
1. [Common Pitfalls & Vendor Headaches](#common-pitfalls--vendor-headaches)
1. [JetThoughts Playbook — The 5 Core Moves](#jetthoughts-playbook--the-5-core-moves)
  3.1. [Cross‑Functional Value‑Stream Squads](#31-cross-functional-value-stream-squads)
  3.2. [Shape Up 6‑Week Cycles](#32-shape-up-6-week-cycles)
  3.3. [Kanban Flow & WIP Limits](#33-kanban-flow--wip-limits)
  3.4. [Test‑Driven Development & Tiny PRs](#34-test-driven-development--tiny-prs)
  3.5. [CI/CD by Day 30](#35-cicd-by-day-30)
