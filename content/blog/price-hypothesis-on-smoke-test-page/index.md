...
> Input: a live smoke-test landing page from Chapter 2.1. Output: a price hypothesis with a measured click-to-payment signal.

If you landed here directly, start at [Chapter 2.1](/blog/smoke-test-landing-page-300-dollar-validation/) to build your smoke-test page first - this chapter adds a price signal on top of the demand signal you already measured.
...
| Advance | 5-9% | Price-validated hypothesis. Move to Module 3 customer interviews. Email everyone who clicked but didn't complete - the most valuable interview group. |
...
- [ ] GA4 + Clarity events tracking button clicks and form submissions separately (GA4 = Google Analytics 4, tracks page visits and events for free; Clarity = Microsoft Clarity, records anonymous user sessions for free)
