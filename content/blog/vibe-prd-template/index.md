...
📋 Template companion to the [Module 2.2 post](/blog/one-page-product-brief-vibe-prd/). Print after running the synthesis from [Module 1.3](/blog/validated-problem-statement-decide-whats-next/). Fill in 45 minutes. Hand to your AI agent or contractor tomorrow.
...
Use the markdown block below directly in Notion, Lovable's prompt window, or a Word doc. The [SVG of the page](/blog/one-page-product-brief-vibe-prd/) is embedded in the Module 2.2 post for printing.
...
If you want the doctrine in long form, the [Module 2.2 post](/blog/one-page-product-brief-vibe-prd/) walks through the five sections with the worked example, the decision between Vibe PRD and traditional PRD, and the case for paying $1,000 vs writing the page yourself for free.
