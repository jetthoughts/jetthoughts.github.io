...
description: "There are two simple solutions which will help you make it work. So you create a Heroku app as usual, but do not connect it with the repository."
seo_override: true
...
You can configure this to be executed on CircleCI for release builds. You can take a peek [here](/blog/deploying-jekyll-github-pages-with-circleci-20/) for an example.
...
From our perspective, this solution is preferable because it provides the ability for finer configuration and allows us to utilize Heroku Review Apps which is a great part of our development [process](/blog/heroku-reviews-apps-prevent-delivering-bugs-on-production-ci-startup/).
