---
title: "6.4 · Charge Before You Ship: The Paid Pilot Contract"
...
metatags:
  image: cover.png
  og_title: "6.4 · Charge Before You Ship: The Paid Pilot Contract"
...
canonical_url: "https://jetthoughts.com/blog/paid-pilot-charge-before-ship/"
related_posts: false
---

> **Module 6 · Step 4 of 5** · [Tech for Non-Technical Founders 2026](/blog/tech-for-non-technical-founders-2026/) course.
> Input: 3-5 warm leads from [Chapter 6.3](/blog/first-ten-customers-personal-network/). Output: 1 signed paid pilot before any new code ships.
...
That is the entire setup. No webhook, no Rails controller, no Django view, no Laravel route. If you want to log paid pilots into your existing app, you can - but you do not have to. The CSV export from Stripe is enough for a Module 6 first-pilot motion.
...
You have a warm lead from [Chapter 6.3](/blog/first-ten-customers-personal-network/) who booked a 20-minute demo, the demo went well, and they said something close to "yes, I would love to try this with my team." Most founders soften here. The 15-second script that does not soften:
...
Notice what the script does not do. It does not apologize for asking for money: the deposit is presented as your standard, not a negotiation. It anchors the conversation in mutual signal, where they get founder time in exchange for a real customer commitment. And it ends with a low-friction next step (the one-pager) rather than asking for a signature today.

The customer's response tells you everything you need to know:

- **"Send the one-pager"** - you are close to a paid pilot. Send it inside the hour.
- **"Can we start free and convert later?"** - still hedging. Reframe and clarify that the deposit is credit toward year-one, not an added cost.
- **"Let me think about it"** - not ready this week. Check back in seven days; the warm lead just got colder.
- **"We do not do paid pilots"** - not in your must-have segment for now. Thank them and move on.
...
If a champion from your Chapter 6.3 list is willing to come into the pilot for free in exchange for a co-marketing case study and a Loom testimonial at the end, that trade is sometimes worth more than the deposit. The case study and the testimonial are your conversion assets for the next 10 customers. Limit this to 1-2 champions out of your first 10 pilots, and only when the case study is contractually committed.

### True early-MVP founder

If your MVP is genuinely 30% built, a paid pilot misrepresents what you can deliver. Do the free pilot honestly, ship the product to the agreed scope, and turn the second customer into the paid one. The honesty signal is itself a commitment device of a different kind.

### Pre-investment-grade product

If your product is 12 months from being differentiable, the customer is buying a relationship, not a product. The relationship motion has its own playbook (see the [Paul Graham "Do Things That Don't Scale"](http://paulgraham.com/ds.html) Stripe Collison example). The paid pilot returns once the product is actually doing the job.
...
4. Send the DPA and Stripe link to 1-2 warm leads from Chapter 6.3 who booked demos last week.
...
If you do not have warm demos to convert this week, your work is still in [Chapter 6.3](/blog/first-ten-customers-personal-network/). The DPA is the wrong sprint for an empty pipeline.
