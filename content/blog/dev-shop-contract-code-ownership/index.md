...
You have a signed master services agreement somewhere in Google Drive, twelve months of paid invoices, and a product your customers open every morning. Your dev shop contract is the only document that decides code ownership, and what you may not have is the legal right to hand that codebase to a different team next month.

Start with the command that tells you who actually wrote it.
...
Your 2023 contract has no opinion about a model writing your code. Your 2026 reality does.
...
Your contract should say what the last two weeks of the relationship look like.

A usable transition clause names hours (say, 40 hours of the departing team's time), a rate, a deadline measured in business days from notice, and a list of deliverables: repository transfer, credential handover, a written architecture summary, and a recorded walkthrough of anything undocumented. Without a number, "reasonable transition assistance" turns into three unanswered emails while your new team burns its first sprint guessing.
...
Yes. Most people reading this did.

You are not stuck, you are just negotiating from a different position. The next SOW, the next renewal, the next scope change is an amendment opportunity, and the moment your agency wants something from you is the moment to attach a two-page addendum: present assignment, contributor warranty, account ownership, transition terms. Send it as housekeeping your investors asked for, because that framing is true and it removes the accusation from the conversation.
...
Ownership is what you use after something has already gone wrong.

None of this makes the code good. You can own every line of a codebase that has no tests and no deploy script, and the paperwork will not shorten the rescue by a day. Clauses cost you something too: a startup lawyer bills real hours to redline an agency MSA properly, a few agencies will walk rather than sign a contributor warranty, and the negotiation adds a week or two before anyone writes code.
