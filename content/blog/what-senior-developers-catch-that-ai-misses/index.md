...
- [Propshaft](https://github.com/rails/propshaft) - the asset pipeline whose behaviour the claim got wrong. Its own README settles it: "All assets in the load path will be copied (or compiled) in a precompilation step for production that also stamps all of them with a digest hash."
