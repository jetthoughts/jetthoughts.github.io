...
var FLBuilderLayoutConfig = {
    ...
    paths: {
        pluginUrl: '/wp-content/plugins/bb-plugin/',
...
jQuery(function($) {
    $(function() {
        $('.fl-node-m6xb85qn107l .fl-photo-img').on('mouseenter', function(e) {
...
jQuery(function($) {
    $(function() {
        $('.fl-node-uqmxksgj6zd4 .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
(function($) {
    function equalheight() {
        ...
        var maxHeight = 0;
        $('.fl-node-cbhworulayqn .pp-logos-wrapper .pp-logo').each(function(index) {
            if (($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
                maxHeight = $(this).find('.logo-image').outerHeight() + 0;
            }
        });
        $('.fl-node-cbhworulayqn .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');
        return maxHeight;
    }
    $('.fl-node-cbhworulayqn .pp-logos-wrapper').imagesLoaded(function() {});
})(jQuery);
(function($) {
    function equalheight() {
        if (window.navigator.userAgent.indexOf('MSIE ') > 0) {
        ...
        var maxHeight = 0;
        $('.fl-node-el3fhm25cy0g .pp-logos-wrapper .pp-logo').each(function(index) {
            if (($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
                maxHeight = $(this).find('.logo-image').outerHeight() + 0;
            }
        });
        $('.fl-node-el3fhm25cy0g .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');
        return maxHeight;
    }
    $('.fl-node-el3fhm25cy0g .pp-logos-wrapper').imagesLoaded(function() {
        var getMinSlides = function() {
            var minSlides = ($(window).width() <= 768) ? parseInt($('.fl-node-el3fhm25cy0g').width() / 250) : 1;
        ...
        var options = {
            ...
            onSliderLoad: function() {
                $('.fl-node-el3fhm25cy0g .pp-logos-wrapper').addClass('pp-logos-wrapper-loaded');
            },
            onSlideBefore: function(ele, oldIndex, newIndex) {
                this.stopAuto(true);
                $('.fl-node-el3fhm25cy0g .logo-slider-nav').addClass('disabled');
                $('.fl-node-el3fhm25cy0g .bx-controls .bx-pager-link').addClass('disabled');
                this.startAuto(true);
            },
            onSlideAfter: function(ele, oldIndex, newIndex) {
                $('.fl-node-el3fhm25cy0g .logo-slider-nav').removeClass('disabled');
                $('.fl-node-el3fhm25cy0g .bx-controls .bx-pager-link').removeClass('disabled');
            }
        };
        ...
        var slider = $('.fl-node-el3fhm25cy0g .pp-logos-wrapper').bxSlider(options);
        slider.data('bxSlider', slider);
    });
})(jQuery);
(function($) {
    $('.fl-node-dxali8vntcr0 .pp-infobox').on('mouseenter', function() {
        $('.fl-node-dxali8vntcr0 .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-dxali8vntcr0 .pp-infobox').on('mouseleave', function() {
        $('.fl-node-dxali8vntcr0 .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-075ztwhd3cxn .pp-infobox').on('mouseenter', function() {
        $('.fl-node-075ztwhd3cxn .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-075ztwhd3cxn .pp-infobox').on('mouseleave', function() {
        $('.fl-node-075ztwhd3cxn .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-lajty926uxf5 .pp-infobox').on('mouseenter', function() {
        $('.fl-node-lajty926uxf5 .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-lajty926uxf5 .pp-infobox').on('mouseleave', function() {
        $('.fl-node-lajty926uxf5 .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-do5fjakv8b29 .pp-infobox').on('mouseenter', function() {
        $('.fl-node-do5fjakv8b29 .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-do5fjakv8b29 .pp-infobox').on('mouseleave', function() {
        $('.fl-node-do5fjakv8b29 .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-3eq5kcmfz0an .pp-infobox').on('mouseenter', function() {
        $('.fl-node-3eq5kcmfz0an .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-3eq5kcmfz0an .pp-infobox').on('mouseleave', function() {
        $('.fl-node-3eq5kcmfz0an .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-v3gpr4klqmob .pp-infobox').on('mouseenter', function() {
        $('.fl-node-v3gpr4klqmob .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-v3gpr4klqmob .pp-infobox').on('mouseleave', function() {
        $('.fl-node-v3gpr4klqmob .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
jQuery(function($) {
    $(function() {
        $('.fl-node-gznl6becvrux .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
jQuery(function($) {
    $(function() {
        $('.fl-node-9qnfpsbwt852 .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
jQuery(function($) {
    $(function() {
        $('.fl-node-v7pa9q5ehwid .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
jQuery(function($) {
    $(function() {
        $('.fl-node-5jwgp0mueqdb .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
jQuery(function($) {
    $(function() {
        $('.fl-node-bh9tdgcwmyz7 .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
jQuery(function($) {
    $(function() {
        $('.fl-node-lg9pu62c0m81 .fl-photo-img').on('mouseenter', function(e) {
            $(this).data('title', $(this).attr('title')).removeAttr('title');
        }).on('mouseleave', function(e) {
            $(this).attr('title', $(this).data('title')).data('title', null);
        });
...
(function($) {
    ...
    var PPContentGridOptions = {
        ...
        fields: {
            ...
            "post_grid_filters": "jt_case_studies_category",
            ...
            "show_date": "no",
            "show_categories": "yes",
            "post_taxonomies": ["jt_case_studies_category"],
            "meta_separator": " | ",
            "terms_separator": "",
            ...
            "posts_jt-careers_matching": "1",
            "posts_jt-careers": "",
            "tax_jt-careers_jt_careers_category_matching": "1",
            "tax_jt-careers_jt_careers_category": "",
            "as_values_posts_jt-careers": "",
            "as_values_tax_jt-careers_jt_careers_category": "",
            "custom_field_relation": "AND",
            "custom_field": [""],
            "post_grid_filters_post_type": "jt_case_studies",
        ...
        filters: false,
        defaultFilter: '',
        filterTax: 'jt_case_studies_category',
        filterType: 'dynamic',
    };
    ppcg_ocvfdn5wibp8 = new PPContentGrid(PPContentGridOptions);
    var state = 0;
    ...
    $(document).on('pp-tabs-switched', function(e, selector) {
        if (selector.find('.pp-content-post-grid').length > 0) {
            ...
            ppcg_ocvfdn5wibp8._gridLayoutMatchHeight();
...
(function($) {
    $('.fl-node-5oyrwk91ufhg .pp-infobox').on('mouseenter', function() {
        $('.fl-node-5oyrwk91ufhg .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-5oyrwk91ufhg .pp-infobox').on('mouseleave', function() {
        $('.fl-node-5oyrwk91ufhg .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-5b7e9qxr14h8 .pp-infobox').on('mouseenter', function() {
        $('.fl-node-5b7e9qxr14h8 .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-5b7e9qxr14h8 .pp-infobox').on('mouseleave', function() {
        $('.fl-node-5b7e9qxr14h8 .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-gyioc8tzs3nr .pp-infobox').on('mouseenter', function() {
        $('.fl-node-gyioc8tzs3nr .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-gyioc8tzs3nr .pp-infobox').on('mouseleave', function() {
        $('.fl-node-gyioc8tzs3nr .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-woz0n3a5ep9x .pp-infobox').on('mouseenter', function() {
        $('.fl-node-woz0n3a5ep9x .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-woz0n3a5ep9x .pp-infobox').on('mouseleave', function() {
        $('.fl-node-woz0n3a5ep9x .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
...
(function($) {
    $(function() {
        ...
        $('.fl-node-vo75i29j3fmz .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
        $('.fl-node-vo75i29j3fmz .pp-tabs-style-2 .pp-tabs-label').on('click', function() {
            $('.fl-node-vo75i29j3fmz .pp-tabs-style-2 .pp-tabs-label').removeClass('pp-no-border');
            $('.fl-node-vo75i29j3fmz .pp-tabs-style-2 .pp-tabs-label.pp-tab-active').prev().addClass('pp-no-border');
        });
        if ($(window).width() > 768) {
            $('.fl-node-vo75i29j3fmz .pp-tabs-vertical .pp-tabs-panel-content').css('min-height', $('.fl-node-vo75i29j3fmz .pp-tabs-vertical .pp-tabs-labels').outerHeight() + 'px');
        }
        if ($(window).width() <= 768) {
            $('.fl-node-vo75i29j3fmz .pp-tabs-label .pp-tab-close').on('click', function() {
...
(function($) {
    function equalheight() {
        ...
        var maxHeight = 0;
        $('.fl-node-mghf7qv58jbu .pp-logos-wrapper .pp-logo').each(function(index) {
            if (($(this).find('.logo-image').outerHeight() + 0) > maxHeight) {
                maxHeight = $(this).find('.logo-image').outerHeight() + 0;
            }
        });
        $('.fl-node-mghf7qv58jbu .pp-logos-wrapper .pp-logo').css('height', maxHeight + 'px');
        return maxHeight;
    }
    $('.fl-node-mghf7qv58jbu .pp-logos-wrapper').imagesLoaded(function() {});
})(jQuery);;
(function($) {
...
(function($) {
  // TODO Research
    var settings = {
        ...
        initialSlide: 0,
        slidesPerView: {
            desktop: (window.innerWidth < 768 ? 1 : 2),
            large: 2,
            tablet: 2,
            mobile: 1,
        },
    ...
    carousel_08kl1yzxeout = new PPReviewsCarousel(settings);

    function updateCarousel() {
        setTimeout(function() {
            if ('number' !== typeof carousel_08kl1yzxeout.swipers.main.length) {
                carousel_08kl1yzxeout.swipers.main.update();
            } else {
                carousel_08kl1yzxeout.swipers.main.forEach(function(item) {
    ...
    $(document).on('pp_modal_box_rendered', function(e, selector) {
        if (selector.find('.fl-node-08kl1yzxeout').length > 0) {
            updateCarousel();
        }
    });
    $(document).on('fl-builder.pp-accordion-toggle-complete', function(e) {
        if ($(e.target).find('.fl-node-08kl1yzxeout').length > 0) {
            updateCarousel();
        }
    });
    $(document).on('pp-tabs-switched', function(e, selector) {
    ...
    $('.fl-tabs').find('.fl-tabs-label').on('click', function() {
        ...
        if (panel.find('.fl-node-08kl1yzxeout').length > 0) {
            updateCarousel();
        }
    });
    var state = 0;
    $(document).on('pp_expandable_row_toggle', function(e, selector) {
        if (selector.is('.pp-er-open') && state === 0 && selector.find('.fl-node-08kl1yzxeout').length > 0) {
            updateCarousel();
            state = 1;
        }
    });
