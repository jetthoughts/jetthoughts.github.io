...
jQuery(function($) {
    $(function() {
        $('.fl-node-19njtzagfebh .fl-photo-img').on('mouseenter', function(e) {
...
(function($) {
    $('.fl-node-5tmpu20yerbq .pp-infobox').on('mouseenter', function() {
        $('.fl-node-5tmpu20yerbq .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-5tmpu20yerbq .pp-infobox').on('mouseleave', function() {
        $('.fl-node-5tmpu20yerbq .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-k0y7grmbj6n8 .pp-infobox').on('mouseenter', function() {
        $('.fl-node-k0y7grmbj6n8 .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-k0y7grmbj6n8 .pp-infobox').on('mouseleave', function() {
        $('.fl-node-k0y7grmbj6n8 .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
    $('.fl-node-g5t28lcnjfkh .pp-infobox').on('mouseenter', function() {
        $('.fl-node-g5t28lcnjfkh .pp-icon-wrapper').addClass(' none');
    });
    $('.fl-node-g5t28lcnjfkh .pp-infobox').on('mouseleave', function() {
        $('.fl-node-g5t28lcnjfkh .pp-icon-wrapper').removeClass(' none');
    });
})(jQuery);
(function($) {
