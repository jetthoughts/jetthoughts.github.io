...
var flBuilderUrl = "/wp-content/plugins/bb-plugin/"
var FLBuilderLayoutConfig = {
  anchorLinkAnimations: { duration: 1000, easing: "swing", offset: 100 },
  paths: { pluginUrl: "/wp-content/plugins/bb-plugin/", wpAjaxUrl: "/wp-admin/admin-ajax.php" },
...
(function ($) {
  $(".fl-node-0pigeztak1xl .pp-infobox").on("mouseenter", function () {$(".fl-node-0pigeztak1xl .pp-icon-wrapper").addClass(" none")})
  $(".fl-node-0pigeztak1xl .pp-infobox").on("mouseleave", function () {$(".fl-node-0pigeztak1xl .pp-icon-wrapper").removeClass(" none")})
})(jQuery);
(function ($) {
  $(".fl-node-ugiypbhnvlfw .pp-infobox").on("mouseenter", function () {$(".fl-node-ugiypbhnvlfw .pp-icon-wrapper").addClass(" none")})
  $(".fl-node-ugiypbhnvlfw .pp-infobox").on("mouseleave", function () {$(".fl-node-ugiypbhnvlfw .pp-icon-wrapper").removeClass(" none")})
})(jQuery);
(function ($) {
  $(".fl-node-h2wjp3zb7afk .pp-infobox").on("mouseenter", function () {$(".fl-node-h2wjp3zb7afk .pp-icon-wrapper").addClass(" none")})
  $(".fl-node-h2wjp3zb7afk .pp-infobox").on("mouseleave", function () {$(".fl-node-h2wjp3zb7afk .pp-icon-wrapper").removeClass(" none")})
})(jQuery);
(function ($) {
  $(".fl-node-nwx7eiysakvl .pp-infobox").on("mouseenter", function () {$(".fl-node-nwx7eiysakvl .pp-icon-wrapper").addClass(" none")})
  $(".fl-node-nwx7eiysakvl .pp-infobox").on("mouseleave", function () {$(".fl-node-nwx7eiysakvl .pp-icon-wrapper").removeClass(" none")})
})(jQuery);
(function ($) {
  $(".fl-node-a5khmr6nto3z .pp-infobox").on("mouseenter", function () {$(".fl-node-a5khmr6nto3z .pp-icon-wrapper").addClass(" none")})
  $(".fl-node-a5khmr6nto3z .pp-infobox").on("mouseleave", function () {$(".fl-node-a5khmr6nto3z .pp-icon-wrapper").removeClass(" none")})
})(jQuery);
(function ($) {
  $(".fl-node-2ufxtslray80 .pp-infobox").on("mouseenter", function () {$(".fl-node-2ufxtslray80 .pp-icon-wrapper").addClass(" none")})
  $(".fl-node-2ufxtslray80 .pp-infobox").on("mouseleave", function () {$(".fl-node-2ufxtslray80 .pp-icon-wrapper").removeClass(" none")})
})(jQuery)
jQuery(function ($) {
  $(function () {$(".fl-node-r4l68x09cspw .fl-photo-img").on("mouseenter", function (e) {$(this).data("title", $(this).attr("title")).removeAttr("title")}).on("mouseleave", function (e) {$(this).attr("title", $(this).data("title")).data("title", null)})})
  window._fl_string_to_slug_regex = "a-zA-Z0-9"
})
jQuery(function ($) {
  $(function () {$(".fl-node-qhzfase1i9cv .fl-photo-img").on("mouseenter", function (e) {$(this).data("title", $(this).attr("title")).removeAttr("title")}).on("mouseleave", function (e) {$(this).attr("title", $(this).data("title")).data("title", null)})})
  window._fl_string_to_slug_regex = "a-zA-Z0-9"
})
jQuery(function ($) {
  $(function () {$(".fl-node-m6v9zbegfwty .fl-photo-img").on("mouseenter", function (e) {$(this).data("title", $(this).attr("title")).removeAttr("title")}).on("mouseleave", function (e) {$(this).attr("title", $(this).data("title")).data("title", null)})})
  window._fl_string_to_slug_regex = "a-zA-Z0-9"
})
jQuery(function ($) {
  $(function () {$(".fl-node-qycurg0dkl65 .fl-photo-img").on("mouseenter", function (e) {$(this).data("title", $(this).attr("title")).removeAttr("title")}).on("mouseleave", function (e) {$(this).attr("title", $(this).data("title")).data("title", null)})})
  window._fl_string_to_slug_regex = "a-zA-Z0-9"
})
jQuery(function ($) {
  $(function () {$(".fl-node-0a2z6mvbnldq .fl-photo-img").on("mouseenter", function (e) {$(this).data("title", $(this).attr("title")).removeAttr("title")}).on("mouseleave", function (e) {$(this).attr("title", $(this).data("title")).data("title", null)})})
  window._fl_string_to_slug_regex = "a-zA-Z0-9"
})
jQuery(function ($) {
  $(function () {$(".fl-node-sqo2l4p6xfne .fl-photo-img").on("mouseenter", function (e) {$(this).data("title", $(this).attr("title")).removeAttr("title")}).on("mouseleave", function (e) {$(this).attr("title", $(this).data("title")).data("title", null)})})
  window._fl_string_to_slug_regex = "a-zA-Z0-9"
});
(function ($) {
...
;(function ($) {
  $(function () {
    ...
    $(".fl-node-fy2sd3rz1qtj .pp-tabs-style-2 .pp-tabs-label.pp-tab-active").prev().addClass("pp-no-border")
    $(".fl-node-fy2sd3rz1qtj .pp-tabs-style-2 .pp-tabs-label").on("click", function () {
      $(".fl-node-fy2sd3rz1qtj .pp-tabs-style-2 .pp-tabs-label").removeClass("pp-no-border")
      $(".fl-node-fy2sd3rz1qtj .pp-tabs-style-2 .pp-tabs-label.pp-tab-active").prev().addClass("pp-no-border")
    })
    if ($(window).width() > 768) {$(".fl-node-fy2sd3rz1qtj .pp-tabs-vertical .pp-tabs-panel-content").css("min-height", $(".fl-node-fy2sd3rz1qtj .pp-tabs-vertical .pp-tabs-labels").outerHeight() + "px")}
    if ($(window).width() <= 768) {$(".fl-node-fy2sd3rz1qtj .pp-tabs-label .pp-tab-close").on("click", function () {$(this).parents(".pp-tabs-label").removeClass("pp-tab-active")})}
  })
})(jQuery);
(function ($) {
  function equalheight () {
    ...
    var maxHeight = 0
    $(".fl-node-18t7eb9urgzj .pp-logos-wrapper .pp-logo").each(function (index) {if (($(this).find(".logo-image").outerHeight() + 0) > maxHeight) {maxHeight = $(this).find(".logo-image").outerHeight() + 0}})
    $(".fl-node-18t7eb9urgzj .pp-logos-wrapper .pp-logo").css("height", maxHeight + "px")
    return maxHeight
  }

  $(".fl-node-18t7eb9urgzj .pp-logos-wrapper").imagesLoaded(function () {})
})(jQuery)
;(function ($) {
  PPReviewsCarousel = function (settings) {
    ...
    this.settings = settings
    this.swipers = {}
    if (this._isSlideshow()) {this.slidesPerView = settings.slideshow_slidesPerView}
    if (typeof Swiper === "undefined") {$(window).on("load", function () {if (typeof Swiper === "undefined") {return} else {this._init()}}.bind(this))} else {this._init()}
  }
  PPReviewsCarousel.prototype = {
    ...
    swipers: {},
    _init: function () {
      this.elements = { mainSwiper: this.nodeClass + " .pp-reviews-swiper" }
      ...
      if (1 >= this._getSlidesCount()) {return}
    ...
    _getEffect: function () {return this.settings.effect},
    _getSlidesCount: function () {return this.elements.swiperSlide.length},
    _getInitialSlide: function () {return this.settings.initialSlide},
    _getSpaceBetween: function () {
      var space = this.settings.spaceBetween.desktop, space = parseInt(space)
      if (isNaN(space)) {space = 20}
      return space
    },
    _getSpaceBetweenLarge: function () {
      var space = this.settings.spaceBetween.large, space = parseInt(space)
      if (isNaN(space)) {space = this._getSpaceBetween()}
      return space
    },
    _getSpaceBetweenTablet: function () {
      var space = this.settings.spaceBetween.tablet, space = parseInt(space)
      if (isNaN(space)) {space = this._getSpaceBetweenLarge()}
      return space
    },
    _getSpaceBetweenMobile: function () {
      var space = this.settings.spaceBetween.mobile, space = parseInt(space)
      if (isNaN(space)) {space = this._getSpaceBetweenTablet()}
      return space
    },
    ...
    _getSlidesPerViewLarge: function () {
      ...
      if (slidesPerView === "" || slidesPerView === 0) {slidesPerView = this._getSlidesPerView()}
    ...
    _getSlidesPerViewTablet: function () {
      ...
      if (slidesPerView === "" || slidesPerView === 0) {slidesPerView = this._getSlidesPerViewLarge()}
      if (!slidesPerView && "coverflow" === this.settings.type) {return Math.min(this._getSlidesCount(), 3)}
      return Math.min(this._getSlidesCount(), +slidesPerView)
    },
    _getSlidesPerViewMobile: function () {
      ...
      if (slidesPerView === "" || slidesPerView === 0) {slidesPerView = this._getSlidesPerViewTablet()}
      if (!slidesPerView && "coverflow" === this.settings.type) {return Math.min(this._getSlidesCount(), 3)}
      return Math.min(this._getSlidesCount(), +slidesPerView)
    },
    ...
    _getThumbsSlidesPerViewLarge: function () {
      var slidesPerView = this.slidesPerView.large
      if (slidesPerView === "" || slidesPerView === 0) {slidesPerView = this._getThumbsSlidesPerView()}
      if (!slidesPerView && "coverflow" === this.settings.type) {return Math.min(this._getSlidesCount(), 3)}
      return Math.min(this._getSlidesCount(), +slidesPerView)
    },
    _getThumbsSlidesPerViewTablet: function () {
      var slidesPerView = this.slidesPerView.tablet
      if (slidesPerView === "" || slidesPerView === 0) {slidesPerView = this._getThumbsSlidesPerViewLarge()}
      if (!slidesPerView && "coverflow" === this.settings.type) {return Math.min(this._getSlidesCount(), 3)}
      return Math.min(this._getSlidesCount(), +slidesPerView)
    },
    ...
    _getSlidesToScrollDesktop: function () {return this._getSlidesToScroll("desktop")},
    _getSlidesToScrollLarge: function () {return this._getSlidesToScroll("large")},
    _getSlidesToScrollTablet: function () {return this._getSlidesToScroll("tablet")},
    _getSlidesToScrollMobile: function () {return this._getSlidesToScroll("mobile")},
    _getSwiperOptions: function () {
      var large_breakpoint = this.settings.breakpoint.large, medium_breakpoint = this.settings.breakpoint.medium,
      ...
      var thumbsSliderOptions = {
        ...
        loopedSlides: this._getSlidesCount(),
        speed: this.settings.speed,
        onSlideChangeEnd: function (swiper) {swiper.fixLoop()},
        breakpoints: {}
      }
    ...
    _isSlideshow: function () {return "slideshow" === this.settings.type},
    _onElementChange: function (property) {
      if (0 === property.indexOf("width")) {this.swipers.main.onResize()}
      if (0 === property.indexOf("spaceBetween")) {this._updateSpaceBetween(this.swipers.main, property)}
    },
    _updateSpaceBetween: function (swiper, property) {
      var newSpaceBw = this._getSpaceBetween(), deviceMatch = property.match("space_between_(.*)")
      if (deviceMatch) {
        var breakpoints = {
      ...
      } else {swiper.originalParams.spaceBetween = newSpaceBw}
      swiper.params.spaceBetween = newSpaceBw
      swiper.onResize()
    },
  }
})(jQuery)
var carousel_e7cxg36mjuht = "";
(function ($) {
  var settings = {
    id: "e7cxg36mjuht",
    type: "carousel",
    initialSlide: 0,
    slidesPerView: { desktop: 2, large: 2, tablet: 2, mobile: 1, },
    slidesToScroll: { desktop: 1, large: 1, tablet: 1, mobile: 1, },
    spaceBetween: { desktop: "30", large: "", tablet: "", mobile: "20", },
    ...
    effect: "slide",
    speed: 1000,
    breakpoint: { large: 1200, medium: 1115, responsive: 860 },
  }
  carousel_e7cxg36mjuht = new PPReviewsCarousel(settings)

  function updateCarousel () {setTimeout(function () {if ("number" !== typeof carousel_e7cxg36mjuht.swipers.main.length) {carousel_e7cxg36mjuht.swipers.main.update()} else {carousel_e7cxg36mjuht.swipers.main.forEach(function (item) {if ("undefined" !== typeof item) {item.update()}})}}, 10)}

  $(document).on("pp_modal_box_rendered", function (e, selector) {if (selector.find(".fl-node-e7cxg36mjuht").length > 0) {updateCarousel()}})
  $(document).on("fl-builder.pp-accordion-toggle-complete", function (e) {if ($(e.target).find(".fl-node-e7cxg36mjuht").length > 0) {updateCarousel()}})
  $(document).on("pp-tabs-switched", function (e, selector) {if (selector.find(".fl-node-e7cxg36mjuht").length > 0) {updateCarousel()}})
  $(".fl-tabs").find(".fl-tabs-label").on("click", function () {
    ...
    if (panel.find(".fl-node-e7cxg36mjuht").length > 0) {updateCarousel()}
  })
  var state = 0
  $(document).on("pp_expandable_row_toggle", function (e, selector) {
    if (selector.is(".pp-er-open") && state === 0 && selector.find(".fl-node-e7cxg36mjuht").length > 0) {
      updateCarousel()
      state = 1
    }
  })
...
;(function ($) {
  ...
  PPInfoList.prototype = {
    _init: function () {
      ...
      if ("" === layout.medium) {layout.medium = layout.large}
      ...
      if ("" === breakpoints.medium) {breakpoints.medium = 1024}
...
(function ($) {
  new PPInfoList({
    id: "9bd56tarons2",
    layout: { large: "1", medium: "", responsive: "", },
    breakpoints: { medium: "1115", responsive: "860", },
  })
})(jQuery)
