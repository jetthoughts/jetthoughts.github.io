...
- **Concise EVERYWHERE (Paul 2026-08-25)**: shortest form for messages, code comments, and GitHub artifacts. Comments: skip unless the "why" isn't obvious; one line max. Commit messages, PR titles/bodies, issues: shortest informative form — no preamble, no filler.
