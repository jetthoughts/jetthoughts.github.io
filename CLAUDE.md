...
- **New-doc locations**: reusable process how-tos go under `docs/workflows/`; a major initiative (business operation, campaign, migration, course) gets its own `docs/projects/<YYMM-slug>/` folder following the existing dated-slug convention (2509/2510/2604/2605/2607). Everything else edits an existing file. Do NOT put a whole business/strategy/operating-system under `docs/workflows/` — that dir is for how-tos, not initiatives (flagged 2026-07-22 after the Vibe Code Rescue OS landed in workflows/ and had to move to `docs/projects/2607-vibe-code-rescue/`).
