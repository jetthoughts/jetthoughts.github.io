...
# One representative post per surface; volatile regions (async-rendered
# Mermaid SVG, external iframe) are skipped so the shots stay deterministic.
class BlogSpecialContentDesktopTest < ApplicationSystemTestCase
  ...
  def test_mermaid_post
    ...
    assert_css "div.mermaid", minimum: 1, wait: 5

    assert_stable_screenshot "blog/special/mermaid_post", tolerance: 0.03,
      skip_area: ["div.mermaid", "picture", "img"], stability_time_limit: 1
  end
