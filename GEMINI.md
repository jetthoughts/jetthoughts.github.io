...
**Reference files**: `.stitch/designs/rails-8-1-active-job-continuations-cover.html` · `.stitch/designs/rails-argon2-has-secure-password-cover.html`. Always duplicate, never author from scratch.
...
**Thumbnail**: aspect-preserving 360×189 (2× retina). CSS letterboxes inside 180×180 — NEVER center-crop.
