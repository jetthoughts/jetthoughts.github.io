...
- **SEO Index**: `docs/90-99-content-strategy/seo-optimization/` (old `docs/seo/80.00` link was dead - file never existed)
- **Fractional CTO Optimization**: no dedicated doc exists (the old `docs/seo/80.01` link was dead); use `docs/90-99-content-strategy/seo-optimization/90.09-emergency-cto-seo-audit-reference.md` + the blog-pipeline SEO checklist

### Related Documentation

- **Setup Guide**: `docs/SETUP.md`
- **SEO Implementation Guide**: `docs/90-99-content-strategy/seo-optimization/seo-optimization-implementation-guide.md`
