...
| Evaluate (design system) | `/stitch-design` | Judges the page against the DESIGN SYSTEM rather than against taste (Paul, 2026-08-21). **Name the surface's source first** - site pages are LIGHT (`.okf/design/site-palette.md`); `.stitch/design.md` is the DARK cover system and reviewing a page against it yields the recolour ADR-0003 forbids. Complements the rendered gates: they check what shipped, this checks what was intended. |
