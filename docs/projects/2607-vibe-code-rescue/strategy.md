...
**Part of**: JetThoughts business portfolio bet #1 (state: **Parked** - postponed until Sep 2026). Since 2026-08-20 ALL operations are vault-owned (`~/Documents/pkm`): the weekly loop in `jt-operations.md`, identity/positioning/bet status in `jt-business-os.md`; see the repo [business layer](../../business/index.md) for pointer stubs. This project validates ONE opportunity.
