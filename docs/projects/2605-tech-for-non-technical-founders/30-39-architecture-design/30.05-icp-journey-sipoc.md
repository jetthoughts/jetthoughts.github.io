...
flowchart TB
    ...
    subgraph M2["<b>MODULE 2 · Validate the Problem</b><br/>⏱ 3-5 weeks full-time (booking interviews is the long pole)"]
        ...
        M2_6["2.6 · Build Clickable Prototype<br/>🛠 Lovable<br/>📦 5 silent-observation sessions<br/>Gate: 4+ of 5 pass"]
    end

    M2_6 --> M2_Out(["✅ M2 OUT: 10 scored transcripts + build/pivot/kill decision + prototype feedback + verbatim vocabulary"])
    M2_Out --> M3_1
    ...
    subgraph M4["<b>MODULE 4 · Build It Yourself</b><br/>⏱ 2-4 weeks"]
        ...
        M4_4Fix --> M4_4
        M4_4Gate -.->|Optional| M4_5Opt["4.5 · Ceiling Signals<br/>🛠 Monthly calendar block<br/>📦 Ceiling signal watchlist"]
        M4_5Opt -.-> M4_Out
    ...
    subgraph M5["<b>MODULE 5 · First Paying Customer</b><br/>⏱ 2-4 weeks"]
        ...
        M5_1Gate -->|No| M5_FixProduct["Fix the product before acquiring — back to 4.4"]
        ...
        M5_6Gate -.->|Optional| M5_7Opt["5.7 · Cold Outbound<br/>🛠 LinkedIn Sales Navigator<br/>📦 30 filtered messages, 1-2 pilots"]
        M5_7Opt -.-> M5_Out
    ...
    class M1_1,M1_2,M1_3,M1_4,M1_5,M2_1,M2_3,M2_4,M2_5,M2_6,M3_1,M3_2,M4_1,M4_2,M4_3,M4_4,M5_1,M5_3,M5_4,M5_5,M5_6 lesson
    class M1_1Gate,M1_2Gate,M1_4Gate,M2_5Gate,M4_1Gate,M4_4Gate,M5_1Gate,M5_2Detour,M5_6Gate gate
