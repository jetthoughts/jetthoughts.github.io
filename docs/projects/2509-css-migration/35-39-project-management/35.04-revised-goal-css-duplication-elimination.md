...
|---------|------------------|----------------|----------|
| FL-row foundation | 800-1,200 | 7 files | P0 |
| FL-visible responsive | 500-800 | 7 files | P0 |
| FL-col grid | 600-900 | 7 files | P0 |
| Background patterns | 400-600 | 7 files | P1 |
| @import statements | 84-168 | 7 files | P2 |

**Total Duplication**: 31,094-35,536 lines (70-80% of 44,420 lines)
...
**Duration**: 20-30 hours (2-3 weeks part-time)
**Impact**: 484-768 lines eliminated
...
**WP3.3: PostCSS Final Validation** (4-8 hours)
```yaml
...
**Phase 3 Totals**:
- **Time**: 20-30 hours
- **Lines eliminated**: 484-768 lines
- **Micro-commits**: 50-70 commits
