# Critical CSS Migration Plan: Partial → Direct CSS Includes
...
- **Test Format Requirements**: `docs/60-69-project-management/60.06-test-format-requirements-reference.md`
