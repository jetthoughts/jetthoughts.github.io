# SEO Content Strategy - Goal At-A-Glance
...
**Business plan of record**: content here feeds the [2026 Autumn Client Acquisition Strategy](../../workflows/2026-autumn-client-acquisition-strategy.md) (Vibe Code Rescue offer, 1 client by Nov 30), run via the [Operating System](../../workflows/operating-system.md).
...
**Generate qualified consultation leads and build technical authority** by
publishing content that speaks directly to a **non-technical founder who is
...
tested code, SEO checklist, full blog pipeline (`docs/workflows/blog-pipeline.md`).
